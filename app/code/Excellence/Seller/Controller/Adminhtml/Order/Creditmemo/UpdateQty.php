 ...
 */
namespace Excellence\Seller\Controller\Adminhtml\Order\Creditmemo;
...
class UpdateQty extends \Magento\Backend\App\Action
{
    ...
    public function __construct(
        ...
        \Excellence\Seller\Controller\Adminhtml\Order\CreditmemoLoader $creditmemoLoader,
    ...
    {
        return $this->_authorization->isAllowed('Excellence_Seller::sales_creditmemo');
    }
    ...
    public function execute()
     { 
        ...
        try {
            $this->creditmemoLoader->setFirst($this->getRequest()->getParam('first'));
