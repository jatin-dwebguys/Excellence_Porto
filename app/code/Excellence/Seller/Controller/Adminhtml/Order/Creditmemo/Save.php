...
class Save extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Excellence_Seller::shipment');
    }
    ...
    public function execute()
    {
        ...
        try {
            ...
            if ($creditmemo) {
                ...
                $resultRedirect->setPath('seller/grid/view', ['order_id' => $creditmemo->getOrderId()]);
        ...
        $resultRedirect->setPath('seller/*/new', ['_current' => true]);
        return $resultRedirect;
    }
}
