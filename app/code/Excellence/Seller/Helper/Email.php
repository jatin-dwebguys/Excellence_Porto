<?php
namespace Excellence\Seller\Helper;
...
{
    const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'test/test/your_email_template_field_id';
    ...
    */
    ...
    {    
        //template id (custome template id)
        $this->temp_id=3;
