 ...
 */
namespace Excellence\Seller\Block\Adminhtml\Order;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Excellence_Seller::sales_creditmemo') && $order->canCreditmemo()) {
            $message = __(
        ...
        if ($this->_isAllowedAction('Excellence_Seller::sales_invoice') && $order->canInvoice()) {
    ...
    {
        return $this->getUrl('seller/order_invoice/new');
    }
    ...
    {
        return $this->getUrl('seller/order_creditmemo/new');
    }
    ...
    {
        return $this->getUrl('seller/order_shipment/new');
    }
