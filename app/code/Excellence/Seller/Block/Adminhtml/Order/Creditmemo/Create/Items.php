 ...
 */
namespace Excellence\Seller\Block\Adminhtml\Order\Creditmemo\Create;
...
{  
    ...
    public function canSendCreditmemoEmail()
    {
     ...
     public function getUpdateUrlFirst() {
             return $setupurl = $this->_urlBuilder->getUrl("seller/order_creditmemo/updateQty/order_id/".$this->getCreditmemo()->getOrderId());
       }
}
