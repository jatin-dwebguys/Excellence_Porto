...
namespace Excellence\Filter\Block\Product;
...
class ListProduct extends \Magento\Catalog\Block\Product\AbstractProduct implements IdentityInterface
{
    ...
    protected function _beforeToHtml()
    {
        ...
        $product_sku = $this->_coreRegistry->registry('sku_array');
       $collection->addAttributeToFilter('sku', array('in' => $product_sku))->getData();
